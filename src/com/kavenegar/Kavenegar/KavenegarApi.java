 ...
 */
package com.kavenegar.Kavenegar;

import com.google.gson.*;
import com.kavenegar.Kavenegar.enums.MessageType;
import com.kavenegar.Kavenegar.excepctions.ApiException;
import com.kavenegar.Kavenegar.excepctions.BaseException;
import com.kavenegar.Kavenegar.excepctions.HttpException;
import com.kavenegar.Kavenegar.models.*;
import com.kavenegar.Kavenegar.utils.PairValue;
import com.kavenegar.Kavenegar.utils.StringUtils;
...
public class KavenegarApi {
    ...
    */
    ...
    public List<SendResult> send(String sender, List<String> receptors, String message, MessageType type, long date,
        ...
        JsonArray entry = execute(getApiPath("sms/send"), "sender", sender, "receptor",
                StringUtils.join(",", receptors), "message", message, "type", type.getValue(), "date", date, "localid",
                localIds == null ? "" : StringUtils.join(",", localIds)).getAsJsonArray();
    ...
    */
    ...
    public List<SendResult> CallMakeTTS(String message, List<String> receptors, Long date, List<String> localIds)
            throws BaseException {
        JsonArray entry = execute(getApiPath("call/maketts"), "receptor", StringUtils.join(",", receptors), "message",
                message, "date", date, "localid", localIds == null ? "" : StringUtils.join(",", localIds))
                        .getAsJsonArray();
