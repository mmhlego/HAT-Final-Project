        ...
        public void writeData() {
                try {
                        ...
                        c[4] = new Product("Nokia 8.3 5G",
                                        "128 GB Memory,Quad Camera,Dual SIM,and 6.81-Inch Screen\n(Polar Night)", 17,
                                        575 * dollar);
                        c[5] = new Product("Samsung Galaxy S10+",
                                        "128 GB+8GB RAM SM-G975F/DS Dual SIM 6.4 LTE\n(Prism Black)", 33, 609 * dollar);
                        ...
                        c[12] = new Product("USB mouse", "Mini Cute USB mouse for Laptop, Durable\n(Black)", 100,
                                        3 * dollar);
                        c[13] = new Product("Gaming keyboard",
                                        "Corsair K55 RGB Gaming Keyboard-IP42 Dust and water Resistance", 50,
                                        13 * dollar);
                        c[14] = new Product("USB C to HDMI Adapter",
                                        "nonda USB type-C to HDMI Adapter for Macbook Pro 2017/2016", 60, 6 * dollar);
                        ...
                        c[17] = new Product("32 GB memory card",
                                        ...
                                        150, dollar + 30000);
                        c[18] = new Product("USB lamp light", "Plastic USB lamp light w/metal flux", 90,
                                        2 * dollar + 50000);
                        c[19] = new Product("Light bulb",
                                        ...
                                        140, dollar - 50000);
                        c[20] = new Product("Solimo hand sanitizer",
                                        "62% Ethyl Alcohol\nkill more than 99.99%  of common germs", 1000, dollar / 2);
                        c[21] = new Product("Hand sanitizer gel", "Wave hand sanitizer gel ,75% Ethyl Alcohol", 500,
                                        dollar - 70000);
                        c[22] = new Product("Men masks",
                                        "Men masks for coronavirus protection\ncomfortable and washable", 1000,
                                        dollar / 12);
