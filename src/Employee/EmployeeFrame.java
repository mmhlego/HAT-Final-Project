...
public class EmployeeFrame extends JFrame {
    ...
    public void RightClick()
	{
        ...
        RightItemCustomers.addActionListener((e) -> {selectButton(Customers); addPanel(new EmployeeCustomers(currentUser, this));});
        RightItemProducts.addActionListener((e) -> {selectButton(Products); addPanel(new EmployeeProducts(currentUser, this));});
