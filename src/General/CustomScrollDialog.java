...
public class CustomScrollDialog extends JDialog {
    ...
    public CustomScrollDialog(int Count,User u) {
    	currentUser=u;

        setLayout(null);
        setSize(460, 400);
        panel.setLayout(null);
        panel.setBackground(currentUser.theme.dialog.background);
        ...
        Scroller.setBackground(currentUser.theme.dialog.background);

        JButton Return = new JButton("Return");
        Return.setBounds(10, 360, 440, 30);
        Return.setFont(currentUser.theme.dialog.font);
        Return.setBackground(currentUser.theme.dialog.buttonBackground);
        Return.setForeground(currentUser.theme.dialog.fontColor);
        ...
        setResizable(false);
        setVisible(true);
        getContentPane().setBackground(currentUser.theme.dialog.background);
    }

    public void addButton(JButton b) {
        b.setBounds(20, 20 + i * 50, w, 30);
        b.setBackground(currentUser.theme.dialog.buttonBackground);
        i++;
        panel.add(b);
    }
    ...
    public void addLabel(JLabel l, int row, int side) {
        ...
        l.setFont(currentUser.theme.dialog.font);
        l.setForeground(currentUser.theme.dialog.fontColor);
        panel.add(l);
    }
}
