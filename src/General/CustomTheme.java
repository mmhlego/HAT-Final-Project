...
public class CustomTheme extends JDialog {
    ...
    CustomTheme(User u,JFrame f)
    {
        ...
        String[] sidePanel={"side panel theme","cyan","gray","lime","orange","light","dark","brown","classic","magenta"};
        String[] background={"background theme","cyan","gray","lime","orange","light","dark","brown","classic","magenta"};
        String[] dialog={"dialog theme","cyan","gray","lime","orange","light","dark","brown","classic","magenta"};
