...
public class Captcha extends JPanel{
	...
	JFrame parent;
	User currentUser;
	public Captcha(User u,JFrame f){
		parent=f;
		currentUser=u;
		...
		String captcha1=elements[random.nextInt(61)];
		String captcha2=elements[random.nextInt(61)];
		String captcha3=elements[random.nextInt(61)];
		String captcha4=elements[random.nextInt(61)];
		System.out.print(captcha1+captcha2+captcha3+captcha4);
		...
		label4.setBounds(random.nextInt(10)+1,random.nextInt(6)+1,24,24);
	   	...
	   	label1.setFont(new Font(font.getFamily(),font.getStyle(),random.nextInt(8)+12));
	   	label2.setFont(new Font(font.getFamily(),font.getStyle(),random.nextInt(8)+12));
	    label3.setFont(new Font(font.getFamily(),font.getStyle(),random.nextInt(8)+12));
	   	label4.setFont(new Font(font.getFamily(),font.getStyle(),random.nextInt(8)+12));
