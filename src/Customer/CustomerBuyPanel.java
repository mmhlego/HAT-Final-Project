...
public class CustomerBuyPanel extends JDialog {
    ...
    CustomerBuyPanel(Customer user, Product p, CustomerProducts pa) {
        ...
        {
            DiscountShow.setIcon(new ImageIcon(System.getProperty("user.dir") + "\\Images\\Products Icons\\Events\\Out Of Stock.png"));
            JLabel LowAmount = new JLabel("Out Of Stock !");
        ...
        {
            DiscountShow.setIcon(new ImageIcon(System.getProperty("user.dir") + "\\Images\\Products Icons\\Events\\Hot Sale.png"));
            JLabel LowAmount = new JLabel("Special Offer !");
            LowAmount.setFont(new Font("Dialog", Font.BOLD, 16 ));
            LowAmount.setForeground(currentUser.theme.main.fontColor);
            LowAmount.setBounds(365, 148, 128, 30);
            buy.add(LowAmount);
        ...
        {
            DiscountShow.setIcon(new ImageIcon(System.getProperty("user.dir") + "\\Images\\Products Icons\\Events\\Shelf.png"));
        }
